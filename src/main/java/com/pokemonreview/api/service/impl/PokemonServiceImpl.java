...
public class PokemonServiceImpl implements PokemonService {
    ...
    public PokemonResponse getAllPokemon(int pageNo, int pageSize) {
        ...
        //map returns a list
        List<PokemonDto> content = listOfPokemon.stream().map(p -> mapToDto(p)).collect(Collectors.toList()); //stream is a datastructure that can be manipulated using streamapi mainly used for nor using for loops
